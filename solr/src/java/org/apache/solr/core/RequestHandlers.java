...
final class RequestHandlers {
   ...
   * move
   * 
   * @version $Id: RequestHandlers.java 945886 2010-05-18 21:07:28Z hossman $
   * @since solr 1.2
   */
  private static final class LazyRequestHandlerWrapper implements SolrRequestHandler, SolrInfoMBean
  {
    ...
    public String getSourceId() {
      String rev = "$Id: RequestHandlers.java 945886 2010-05-18 21:07:28Z hossman $";
      if( _handler != null ) {
